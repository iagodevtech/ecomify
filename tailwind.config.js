  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Cores futurísticas personalizadas
        neon: {
          blue: "#00f5ff",
          purple: "#bf00ff",
          green: "#00ff41",
      ...
      backgroundImage: {
        ...
        'neon-glow': 'linear-gradient(45deg, #00f5ff, #bf00ff, #00ff41)',
      },
      backgroundSize: {
        'grid': '20px 20px',
      },
      ...
      boxShadow: {
        ...
        'cyber': '0 0 20px rgba(0,245,255,0.3), inset 0 0 20px rgba(0,245,255,0.1)',
      }
    },
  },
